...
<div class="container mt-5 col-md-8">
    <div class="form-box">
        <h2 class="text-center mb-4">Report Lost Item</h2>
        ...
        <form action="SubmitLostItemServlet" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="locationLost" class="form-control" required>
            </div>
            <div class="mb-3">
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-submit">Submit Lost Item Report</button>
